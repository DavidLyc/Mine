...
public class ManageDoingPresenter extends ManageBasePresenter<ManageDoingContract.View>
        implements ManageDoingContract.Presenter {

    ManageDoingPresenter(@NonNull ManageDoingContract.View view, @NonNull Context context) {
        super(view, context);
