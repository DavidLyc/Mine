...
public class ManageOverdueFragment extends ManageBaseFragment implements ManageOverdueContract.View {
    ...
    private ManageOverdueContract.Presenter mPresenter;
    ...
    public static ManageOverdueFragment newInstance() {
        return new ManageOverdueFragment();
    }
    ...
    @Override
    public void setPresenter(ManageOverdueContract.Presenter presenter) {
