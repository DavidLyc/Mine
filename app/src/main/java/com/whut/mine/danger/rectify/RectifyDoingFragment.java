...
import com.whut.mine.adapter.RectifyListSolvingAdapter;
...
public class RectifyDoingFragment extends BaseFragment implements RectifyDoingContract.View {
    ...
    private RectifyDoingContract.Presenter mPresenter;
    private MaterialDialog mDialog;
    private List<RectifyListItem> mListItems;
    private RectifyListSolvingAdapter mAdapter;
    ...
    public static RectifyDoingFragment newInstance() {
        return new RectifyDoingFragment();
    }
    ...
    @Override
    public void setPresenter(RectifyDoingContract.Presenter presenter) {
    ...
    private void initRecyclerview() {
        ...
        mAdapter = new RectifyListSolvingAdapter(R.layout.rectify_list_item, this, mListItems);
    ...
    @Override
    public void showDoingAlarms(List<RectifyListItem> items) {
